...
export default function Profile() {
  ...
  const handleFileUpload = file => {
    // the app comes from the firebase.js
    ...
    uploadTask.on('state_changed', 
      ...
      // set an error to true if there is any
      (error) => {
        setFileUploadError(true);
      },

      // This function runs when the upload is complete and successful
      // Get the download URL of the uploaded file
      () => {
        getDownloadURL(uploadTask.snapshot.ref)
          .then(downloadURL => {
            // Set the download URL in the formData state
